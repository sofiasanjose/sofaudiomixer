// SoAudioMixer/Views/Components/MouseInsideModifier.swift
import SwiftUI

extension View {
    /// Tracks mouse enter/exit for hover effects in non-key windows (like NSPanel dropdowns)
    ...
    private struct Representable: NSViewRepresentable {
        ...
        func makeNSView(context: Context) -> NSView {
            ...
            let options: NSTrackingArea.Options = [
                ...
                .inVisibleRect,
                .activeAlways  // Critical for non-key windows like NSPanel
            ]
