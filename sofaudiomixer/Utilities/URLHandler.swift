// SoAudioMixer/Utilities/URLHandler.swift
import Foundation
import os

/// Handles URL scheme actions for SoAudioMixer (sofaudiomixer://...)
@MainActor
final class URLHandler {
    private let audioEngine: AudioEngine
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "SoAudioMixer", category: "URLHandler")
    ...
    func handleURL(_ url: URL) {
        ...
        guard url.scheme == "sofaudiomixer" else {
    ...
    /// URL format: sofaudiomixer://set-volumes?app=com.a&volume=100&app=com.b&volume=50
    ...
    /// URL format: sofaudiomixer://step-volume?app=com.a&direction=up (or down)
    ...
    /// URL format: sofaudiomixer://set-mute?app=com.a&muted=true&app=com.b&muted=false
    ...
    /// URL format: sofaudiomixer://toggle-mute?app=com.a&app=com.b
    ...
    /// URL format: sofaudiomixer://set-device?app=com.a&device=<deviceUID>
    ...
    /// URL format: sofaudiomixer://reset?app=com.a&app=com.b or sofaudiomixer://reset (all apps)
