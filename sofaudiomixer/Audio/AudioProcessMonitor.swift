// SoAudioMixer/Audio/AudioProcessMonitor.swift
import AppKit
import AudioToolbox
import os
...
final class AudioProcessMonitor {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "SoAudioMixer", category: "AudioProcessMonitor")
