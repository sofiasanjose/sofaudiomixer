// SoAudioMixer/Audio/DeviceVolumeMonitor.swift
import AppKit
import AudioToolbox
import os
...
final class DeviceVolumeMonitor {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "SoAudioMixer", category: "DeviceVolumeMonitor")
